...
public class SolutionDay07Test : SolutionDay07
{
    ...
    [TestMethod]
    public void ResolvePart1Test() => new SolutionDay07().Resolve(1, Part1Input).Should().Be(Part1Expected);
    ...
    [TestMethod]
    public void ResolvePart2Test() => new SolutionDay07().Resolve(2, Part2Input).Should().Be(Part2Expected);      
}